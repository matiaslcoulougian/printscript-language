...
data class IfAST(val condition: AST, val ifBlock: BlockAST, val elseBlock: BlockAST?, val line: Int, val column: Int) : AST {
    ...
    constructor(condition: AST, ifBlock: BlockAST, elseBlock: BlockAST) : this(condition, ifBlock, elseBlock, -1, -1)
    constructor(condition: AST, ifBlock: BlockAST) : this(condition, ifBlock, null, -1, -1)
